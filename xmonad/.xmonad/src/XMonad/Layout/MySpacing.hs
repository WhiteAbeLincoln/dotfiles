...
instance LayoutModifier Spacing a where
    ...
    modifierDescription (Spacing p) = "gaps " ++ show p
...
instance LayoutModifier SpacingWithEdge a where
    ...
    modifierDescription (SpacingWithEdge p) = "gaps " ++ show p
...
instance LayoutModifier SmartSpacing a where
    ...
    modifierDescription (SmartSpacing p) = "gaps " ++ show p
...
instance LayoutModifier SmartSpacingWithEdge a where
    ...
    modifierDescription (SmartSpacingWithEdge p) = "gaps " ++ show p
