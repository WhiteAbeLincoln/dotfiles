# contains options required by linux-builder
# copied from https://github.com/nix-darwin/nix-darwin/blob/nix-darwin-25.05/modules/nix/default.nix
{
  config,
  lib,
  pkgs,
  ...
  options = {
    determinate-nix = {
      enable = lib.mkOption {
        ...
        default = true;
        description = ''
          Whether to enable Determinate Nix Darwin Compatibility.
        '';
      };
